...
from scrapy_aio.conf import default_settings
...
class BaseSettings(MutableMapping):
    ...
    def __init__(self, values=None, priority='template'):
        self.frozen = False
        self.attributes = {}
    ...
    def set(self, name, value, priority='template'):
        """
    ...
    def setdict(self, values, priority='template'):
        self.update(values, priority)

    def setmodule(self, module, priority='template'):
        """
    ...
    def update(self, values, priority='template'):
        """
    ...
    def delete(self, name, priority='template'):
        self._assert_mutability()
        priority = get_settings_priority(priority)
